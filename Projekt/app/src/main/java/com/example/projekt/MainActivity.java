        ...
        public void loop() throws ConnectionLostException {
            try {
                if(synct == true) {
                    ...
                    Log.d("TACHOMETER READING", "Last impulse duration [s]: " + pulseSeconds + "; Frequency [Hz]: " + freqHz +" TargetFrequency [Hz]: "+targetFreqHz + " RPM is " + freqHz * 60 / 2 + "and should be" + targetFreqHz * 60 / 2);
                }
